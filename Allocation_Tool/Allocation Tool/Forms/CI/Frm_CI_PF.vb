...
Public Class Frm_CI_PF
            ...
            If DataGridViewResources.Columns(e.ColumnIndex).HeaderText = "Actions" Then
                ...
                If DateSerial(dateValue.Year, dateValue.Month, "5") >= DateSerial(Today.Year, Today.Month, Today.Day) Then
                    If DataGridViewResources.Rows.Count > 0 Then
                        ...
                        Frm_CI_Resources_Edit.entry_type = DataGridViewResources.Item(7, e.RowIndex).Value
                        Frm_CI_Resources_Edit.old_value = DataGridViewResources.Item(8, e.RowIndex).Value
                        Frm_CI_Resources_Edit.id_resource = DataGridViewResources.Item(0, e.RowIndex).Value
    ...
    Private Sub ComboBoxProjectType_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBoxProjectType.SelectedIndexChanged
